...
if [ ${Debian_version} == 9 ];then
	wget -N --no-check-certificate https://raw.githubusercontent.com/szliyang/V2ray.Fun/master/enable-debian9-rclocal.sh
...
#Install V2ray.Fun
cd /usr/local/
git clone https://github.com/szliyang/V2ray.Fun
